<div id="comments" class="comments-area">
			...
			<?php $this->commentsNum(_t('当前暂无评论'), _t('仅有一条评论'), _t('已有 %d 条评论')); ?> &raquo;
			</h2>
   ...
   <div class="respond" id="<?php $this->respondId(); ?>">
        <h3 id="reply-title">发表评论 <small><?php $comments->cancelReply(); ?></small></h3>
...
<?php else: ?>
	<div class="respond"><?php _e('评论已关闭'); ?></div>
<?php endif; ?>
